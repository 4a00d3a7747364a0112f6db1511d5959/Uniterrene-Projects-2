...
class Mage_Sales_Model_Order extends Mage_Sales_Model_Abstract
{
    ...
    /*Dynamic Shipping method name added by shourya*/
    
    /*Get Shipping Price In Custom Way*/
    
    public function ShippingDescriptionAmount()
    {
		$order_id = $this->getId();
	...
	/*Custom Shipping Method Dynamic Name Changing*/
	
	public function CusShippingMethodName()
	{
		$order_id = $this->getId();
		...
		if($ship_amount == 0)
		{
			$shipper_name = "Free Shipping";
		}
		else if($ship_amount==89)
		{
			$shipper_name = "LTL";
		}
		else
